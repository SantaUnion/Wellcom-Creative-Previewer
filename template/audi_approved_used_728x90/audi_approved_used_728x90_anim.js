...
function initBanner ()
{
	...
	TweenLite.to("#car", 0, {scaleX:0.3, scaleY:0.3});
...
function mainAnimation () {
	...
	tlAnim.to("#car", 1, 			{delay:0, scale:0.5,  z:0.01, transformOrigin:"144px 104px", ease:Quad.easeInOut});
	...
	tlAnim.to("#car", 2, 			{delay:0, scale:0.94, y:25,  z:0.01, transformOrigin:"144px 104px", ease:Quad.easeInOut}, "=-0.5");
	...
	tlAnim.to("#tandc", 2, 			{delay:0, alpha:1, ease:Quad.easeOut }, "=-1.5");
	tlAnim.to("#cta", 2, 			{delay:0, alpha:1, ease:Quad.easeOut}, "=-1.5");
